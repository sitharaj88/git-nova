...
export { AutolinkService, autolinkService } from './autolinkService';
export type { AutolinkRule } from './autolinkService';
...
export type {
  ...
  SessionEntry,
  UndoEntry,
} from './workspaceStateManager';
export type {
  BranchProtectionRule,
  BranchNamingConvention,
  BranchOperationValidation,
} from './branchProtectionManager';
export type {
  CommitTemplate,
  TemplatePlaceholder,
  ParsedCommitMessage,
} from './commitTemplateManager';
